      ...
      <div className="auth-cnt flex items-center justify-center">
        {
          <div className="relative">
            <form
              className="p-4 bg-secondary-lg rounded-lg text-2xl flex flex-col gap-5"
              onSubmit={loginUser}
            >
              ...
              <div>
                <FormControl
                  sx={{ m: 1, width: "clamp(20ch, 50vw, 25ch)" }}
                  variant="standard"
                >
                  <InputLabel
              ...
              <p className=" text-sm text-primary text-center">
                ...
                <NavLink to="/register" className={"text-danger underline"}>
                  Register Here
                </NavLink>
              </p>
              <Button>Login</Button>
